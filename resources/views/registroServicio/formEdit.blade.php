...
<div class="container">
    ...
    <div class="row" style="margin-top:26px; text-align: center;">
        <h1 class="encabezado">Servicio de salida</h1>
        <div class="form">
        ...
        <table class="tabla tablaUsuarios round_table" style="width: 97%;">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control form-control-sm empresa" name="empresa[]" value="{{$registro->empresa }}" readonly="readonly">
                    </td>
                    <td>
                    ...
                    <td style="display:none;">
                        <input type="text" class="observaciones" name="observaciones[]" value="{{$registro->observaciones }}">
                    </td>
                    <td style="display:none;">
                    ...
                    <td style="display:none;">
                        <input type="text" class="verifico" name="verifico[]" value="{{$registro->verifico }}">
                    </td>
                    <td style="display:none;">
                        <input type="text" class="recibeTurno" name="recibeTurno[]" value="{{$registro->recibeTurno }}">
                    </td>
                    <td style="display:none;">
