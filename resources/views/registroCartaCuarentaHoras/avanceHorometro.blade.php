<style>
    ...
    .timeline {
        list-style: none;
        background-image: url(http://demos.themelize.me/appstrap3.3.2/theme/assets/img/misc/bg_timeline-line.png);
...
<div class="container animated animated-done bootdey" data-animate="fadeIn" data-animate-delay="0.05" style="animation-delay: 0.05s;">
    ...
    <h2 class="text-slab text-center text-uppercase mt-0 mb-5">
        Avance de <span class="font-weight-bold">Horómetro</span>
    </h2>
    <div class="timeline timeline-left mx-lg-10">
        <!--  -->
        <!--  -->
        <!--  -->
        @foreach($datosHorometro as $datoF)
        <br>
        <?php
        date_default_timezone_set("America/Mexico_City");
        setlocale(LC_TIME, 'es_VE.UTF-8', 'esp');
        $data['Fecha'] = $datoF->h_Fecha;
        ...
        <div class="timeline-item mt-3 row text-center p-2">
            ...
            @foreach($datosHorometroEntrada as $datoE)
            @if( ($datoF->h_Fecha == $datoE->h_Fecha.' 00:00:00') && ($datoF->h_Turno == $datoE->h_Turno) )
            ...
            @foreach($datosHorometroSalida as $datoS)
            @if( ($datoF->h_Fecha == $datoS->h_Fecha) && ($datoF->h_Turno == $datoS->h_Turno) )
            ...
            @if($index != 1)
            @if( ($datoF->h_Fecha == $registro->fechaRegistro) && ($datoF->h_Turno == $registro->turno) )
        ...
        <!--  -->
        <!--  -->
        <div class="timeline-breaker timeline-breaker-bottom">Proximos...</div>
    </div>
</div>