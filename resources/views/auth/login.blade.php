...
<div class="contenido__video">
    <!-- 
    autoplay: propiedad para que se reproduzca una ves que carga la página loop: propiedad para el vídeo se repita infinitamente muted: propiedad para que el vídeo no emita sonido poster: propiedad que muestra una imagen hasta que cargue el vídeo 
    -->
    <video class="video" autoplay="autoplay" loop="loop" muted="muted" poster="images/artesano.png">
        <source src="video/Alimak.MP4" type="video/mp4" />
        <!-- <source src="video/Amanda-1920x108.webm" type="video/webm" /> -->
    </video>
</div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <label class="field field_v3">
                        ...
                        <span class="field__label-wrap">
                            <span class="field__label">Num. Empleado</span>
                        </span>
                    </label>
                    @error('email')
